...
public class MealsUtil {
    ...
    private  List<MealWithExceed> mealWithExceeds = getMealsdWithExceeded(meals, 2000);
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public  List<MealWithExceed> getMealsdWithExceeded(List<Meal> meals, int caloriesPerDay) {
        Map<LocalDate, Integer> caloriesSumByDate = meals.stream()
                .collect(
                        Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
                );
